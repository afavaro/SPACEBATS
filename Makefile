...
OBJS = Level.o LevelManager.o Main.o Shader.o Model.o Camera.o Framebuffer.o MotionBlur.o Ship.o Body.o BodyEmitter.o HUD.o HUDComponent.o StatusBar.o Gate.o MusicManager.o ParticleEngine.o ParticleEmitter.o Particle.o
